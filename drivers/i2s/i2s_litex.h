...
#define I2S_STAT_UNDERFLOW_OFFSET   0
...
#define I2S_RX_STAT_DATAREADY_OFFSET   1
#define I2S_RX_STAT_EMPTY_OFFSET       2
#define I2S_RX_STAT_WRCOUNT_OFFSET     3
#define I2S_RX_STAT_RDCOUNT_OFFSET    13
#define I2S_RX_STAT_FIFO_DEPTH_OFFSET 23
#define I2S_RX_STAT_DATAREADY_MASK    (0x1   << I2S_RX_STAT_DATAREADY_OFFSET  )
#define I2S_RX_STAT_EMPTY_MASK        (0x1   << I2S_RX_STAT_EMPTY_OFFSET      )
#define I2S_RX_STAT_WRCOUNT_MASK      (0x1ff << I2S_RX_STAT_WRCOUNT_OFFSET    )
#define I2S_RX_STAT_RDCOUNT_MASK      (0x1ff << I2S_RX_STAT_RDCOUNT_OFFSET    )
#define I2S_RX_STAT_FIFO_DEPTH_MASK   (0x1ff << I2S_RX_STAT_FIFO_DEPTH_OFFSET )
...
#define I2S_TX_STAT_FREE_OFFSET        1
#define I2S_TX_STAT_ALMOSTFULL_OFFSET  2
#define I2S_TX_STAT_WRCOUNT_OFFSET     5
#define I2S_TX_STAT_RDCOUNT_OFFSET    15
#define I2S_TX_STAT_FIFO_DEPTH_OFFSET 25
#define I2S_TX_STAT_FREE_MASK         (0x1   << I2S_TX_STAT_FREE_OFFSET  )
#define I2S_TX_STAT_ALMOSTFULL_MASK   (0x1   << I2S_TX_STAT_ALMOSTFULL_OFFSET      )
#define I2S_TX_STAT_WRCOUNT_MASK      (0x1ff << I2S_TX_STAT_WRCOUNT_OFFSET    )
#define I2S_TX_STAT_RDCOUNT_MASK      (0x1ff << I2S_TX_STAT_RDCOUNT_OFFSET    )
#define I2S_TX_STAT_FIFO_DEPTH_MASK   (0x1ff << I2S_TX_STAT_FIFO_DEPTH_OFFSET )
