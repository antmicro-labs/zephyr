...
* Frame is composed of predefined number of samples. Number of samples is calcualted as **number_of_samples_in_frame * number_of_channels**. Default frame configuration contains 128*1 samples.
